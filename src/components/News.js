...
export class News extends Component {
    ...
    async updateNews() {
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=27cfd6ef87c848799164c01030ff6e98&page=1&pageSize=${this.props.pageSize}`;
                ...
                <div className="row">
                    ...
                    {this.state.articles.map((element) => {
                        return <div className="col-md-4" key={element.url}>
                            <NewsItem title={element.title ? element.title.slice(0, 45) : 'Title is missing'}
                                description={element.description ? element.description.slice(0, 88) : 'Description is missing'} imageUrl={element.urlToImage}
